...
MANIFEST = [
    ...
    ("ninefive.z5",      f"{ZCODE}/905.z5",            "zcode",  None),
    ("adverbum.z5",      f"{ZCODE}/adverbum.z5",       "zcode",  None),
    ("devours.z5",       f"{ZCODE}/devours.z5",        "zcode",  None),
    ("balances.z5",      f"{ZCODE}/Balances.z5",       "zcode",  None),
    ("curves.z8",        f"{ZCODE}/curves.z8",         "zcode",  None),
    ("FailSafe.z5",      f"{ZCODE}/FailSafe.z5",       "zcode",  None),
    ("gostak.z5",        f"{ZCODE}/gostak.z5",         "zcode",  None),
    ("jigsaw.z8",        f"{ZCODE}/Jigsaw.z8",         "zcode",  None),
    ("makeitgood.z8",    f"{ZCODE}/MakeItGood.z8",     "zcode",  None),
    ("shade.z5",         f"{ZCODE}/shade.z5",          "zcode",  None),
    ("aug4.z8",          f"{ZCODE}/Aug4.z8",           "zcode",  None),
    ("christminster.z5", f"{ZCODE}/minster.z5",        "zcode",  None),
    ("varicella.z8",     f"{ZCODE}/vgame.z8",          "zcode",  None),
    ("insight.z5",       f"{ZCODE}/insight.z5",        "zcode",  None),
    ("misdirection.z5",  f"{ZCODE}/Misdirection.z5",   "zcode",  None),
    ("heroes.z5",        f"{ZCODE}/heroes.zip",        "zip",    "heroes.z5"),
    ("weapon.z5",        f"{ZCODE}/weapon.zip",        "zip",    "weapon.z5"),
    ("childsplay.z8",    f"{ZCODE}/ChildsPlay.zblorb", "zblorb", None),
    ("forachange.z5",
     "https://ifarchive.org/if-archive/games/competition99/inform/change/change.z5",
     "zcode", None),
    ("actofmurder.z8",
     "https://ifarchive.org/if-archive/games/competition2007/zcode/actofmurder/ActofMurder.z8",
     "zcode", None),
