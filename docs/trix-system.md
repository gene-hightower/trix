...
as a header-only C++23 library.  It provides 829 operators spanning eight
...
- **Operators** call native C++ functions (the 829 built-in operators).
...
language -- VM, scanner, interpreter, all 829 operators, all 31 types --
...
files.  The full test suite is 20,200+ assertions across 274 test files.  The
...
| Document            | Covers                                    |
| ------------------- | ----------------------------------------- |
| `trix-reference.md` | Complete operator reference (all 829 ops) |
