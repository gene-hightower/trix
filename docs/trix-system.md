...
as a header-only C++23 library.  It provides 840 operators spanning eight
...
- **Operators** call native C++ functions (the 840 built-in operators).
...
language -- VM, scanner, interpreter, all 840 operators, all 32 types --
...
| Document            | Covers                                    |
| ------------------- | ----------------------------------------- |
| `trix-reference.md` | Complete operator reference (all 840 ops) |
