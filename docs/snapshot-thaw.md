...
| Section | Contents |
| --- | --- |
| Identity | Magic `{'T','R','I','X'}`, `snapshot_version` (`uint32_t`, currently 177), endianness flag |
...
**SNAPSHOT_VERSION = 177** is the current snapshot format (see
...
**177**) -- there is no major/minor/patch version. Thaw requires an **exact**
