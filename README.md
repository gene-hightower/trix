...
<a href="examples/amazing.trx"><code>examples/amazing.trx</code></a> &mdash; twelve maze algorithms across five
...
| [amazing.trx](examples/amazing.trx) | Maze zoo -- twelve algorithms (incl. Origin Shift) across five grid topologies, distance-field heatmaps, PNG output |
